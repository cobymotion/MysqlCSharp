...
namespace BackEndMysql.Controller
{
    public class ManageConnection
    {
        ...
        protected MySqlDataReader buscaRegistroStoredProcedure(string nombreProcedimiento, List<MySqlParameter> parametros)
        {
        ...
        protected MySqlDataReader buscaRegistroSQL(string sentencia, List<MySqlParameter> parametros)
        {
            MySqlDataReader reader;
            try
            {
        ...
        /// <param name="parametros"></param>
        /// <returns></returns>
        protected DataTable getListSentenciaSQL(String sentencia, List<MySqlParameter> parametros)
        {
